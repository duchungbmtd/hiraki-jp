...
class JapaneseVocabApp {
    ...
    setupEventListeners() {
        ...
        // Flashcard and Quiz controls removed - now handled in separate pages
        ...
        document.addEventListener('keydown', (e) => {
            ...
            if (flashcardView && !flashcardView.classList.contains('hidden')) {
                switch(e.key) {
                // Keyboard shortcuts for flashcard/quiz removed - now handled in separate pages
                }
            }
        });
    }
    ...
    getCategoryColor(category) {
        const colors = {
            ...
            'verb': 'border-emerald-400',
            'adjective': 'border-rose-400',
            'noun': 'border-slate-400',
            'adverb': 'border-violet-400',
            'expression': 'border-fuchsia-400',
            'family': 'border-amber-400',
            'animal': 'border-lime-400',
            'nature': 'border-green-500',
            'weather': 'border-sky-400',
            'health': 'border-red-500',
            'work': 'border-blue-500',
            'education': 'border-indigo-500',
            'clothing': 'border-pink-500',
            'household': 'border-orange-500',
            'sports': 'border-green-600',
            'music': 'border-purple-500',
            'art': 'border-pink-600',
            'culture': 'border-yellow-500',
            'travel': 'border-cyan-500',
            'technology': 'border-blue-600',
            'science': 'border-indigo-600',
            'society': 'border-gray-500',
            'abstract': 'border-slate-500',
            'activity': 'border-emerald-500',
            'event': 'border-rose-500',
            'disaster': 'border-red-600',
            'incident': 'border-orange-600',
            'money': 'border-yellow-600',
            'transport': 'border-cyan-600',
            'utility': 'border-slate-600',
            'company': 'border-gray-600',
            'document': 'border-slate-700',
            'item': 'border-gray-700',
            'toy': 'border-pink-700',
            'honorific': 'border-purple-600',
            'name': 'border-indigo-700',
            'counter': 'border-blue-700',
            'comparison': 'border-violet-500',
            'particle': 'border-slate-800',
            'conjunction': 'border-gray-800'
        };
